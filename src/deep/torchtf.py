...
__all__ = ['TransformerEncoder', 'TransformerDecoder', 'TransformerEncoderLayer', 'TransformerDecoderLayer']
...
class TransformerEncoderLayer(Module):
    ...
    def _sa_block(self, x: Tensor,
        ...
        x, w = self.self_attn(x, x, x,
                           ...
                           need_weights=store_attention, is_causal=is_causal)
        if store_attention: 
            #print(f'storing-attention!')
...
class TransformerDecoder(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, multi_memory: bool=False, tgt_mask: Optional[Tensor] = None,
        ...
        if multi_memory:
            for mod,mem in zip(self.layers, memory):
